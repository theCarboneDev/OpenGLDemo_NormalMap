...
#define cubeVerticesSize 108
    ...
    //textures
    unsigned int albedoTexture = loadTexture("rustediron/rustediron2_basecolor.png", GL_SRGB_ALPHA);
    unsigned int metallicTexture = loadTexture("rustediron/rustediron2_metallic.png");
    unsigned int normalTexture = loadTexture("rustediron/rustediron2_normal.png");
    unsigned int roughnessTexture = loadTexture("rustediron/rustediron2_roughness.png");
    unsigned int aoTexture = loadTexture("rustediron/rustediron2_ao.png");
